...
@section('content')
  {{-- Title Section --}}
  <section class="title-section pd-lr" style="background-image: url('{{asset('/img/img_ornamentacion2.jpg')}}')">
  ...
  <section class="cta-visita background-blue">
    ...
    <div class="item-img" style="background-image: url('{{ asset('/img/cta_ornamentacion2.jpg') }}')"></div>
  </section>
@endsection
